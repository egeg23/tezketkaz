...
class L10n extends ChangeNotifier {
  ...
  static const _strings = <String, Map<String, String>>{
    ...
    // ── Courier active-order screen ─────────────────────────────────────────
    'courier.active.step_go_to_shop': {
      'uz': 'Do\'konga boring',
      'ru': 'Идите в магазин',
      'en': 'Go to the shop',
      'kk': 'Дүкенге барыңыз',
    },
    'courier.active.step_confirm_pickup': {
      'uz': 'Buyurtmani oling',
      'ru': 'Заберите заказ',
      'en': 'Pick up the order',
      'kk': 'Тапсырысты алыңыз',
    },
    'courier.active.step_go_to_customer': {
      'uz': 'Xaridorga boring',
      'ru': 'Везите покупателю',
      'en': 'Go to the customer',
      'kk': 'Сатып алушыға барыңыз',
    },
    'courier.active.step_at_customer': {
      'uz': 'Mahsulot topshiring',
      'ru': 'Передайте заказ',
      'en': 'Hand over the order',
      'kk': 'Тапсырысты беріңіз',
    },
    'courier.active.step_done': {
      'uz': 'Bajarildi',
      'ru': 'Готово',
      'en': 'Done',
      'kk': 'Дайын',
    },
    'courier.active.cta_at_shop': {
      'uz': '🏪  Do\'konga yetib keldim',
      'ru': '🏪  Я в магазине',
      'en': '🏪  I\'m at the shop',
      'kk': '🏪  Дүкенге жеттім',
    },
    'courier.active.cta_picked_up': {
      'uz': '✓  Buyurtmani oldim',
      'ru': '✓  Заказ забрал',
      'en': '✓  Order picked up',
      'kk': '✓  Тапсырысты алдым',
    },
    'courier.active.cta_at_door': {
      'uz': '🏠  Xaridor eshigiga yetdim',
      'ru': '🏠  Я у двери покупателя',
      'en': '🏠  At the customer\'s door',
      'kk': '🏠  Сатып алушының есігіндемін',
    },
    'courier.active.cta_handed_off': {
      'uz': '🎉  Mahsulot topshirildi',
      'ru': '🎉  Заказ передан',
      'en': '🎉  Order handed over',
      'kk': '🎉  Тапсырыс берілді',
    },
    'courier.active.cta_new_orders': {
      'uz': 'Yangi buyurtmalar',
      'ru': 'Новые заказы',
      'en': 'New orders',
      'kk': 'Жаңа тапсырыстар',
    },
    'courier.active.cancel_title': {
      'uz': 'Buyurtmani tark etish?',
      'ru': 'Отказаться от заказа?',
      'en': 'Leave this order?',
      'kk': 'Тапсырыстан бас тарту керек пе?',
    },
    'courier.active.cancel_subtitle': {
      'uz': 'Tez-tez tark etish reytingingizni pasaytiradi.',
      'ru': 'Частые отказы снижают ваш рейтинг.',
      'en': 'Frequent drops will lower your rating.',
      'kk': 'Жиі бас тарту рейтингіңізді төмендетеді.',
    },
    'courier.active.cancel_reason_road': {
      'uz': 'Yo\'lda muammo yuz berdi',
      'ru': 'Проблема в пути',
      'en': 'Trouble on the way',
      'kk': 'Жолда мәселе болды',
    },
    'courier.active.cancel_reason_closed': {
      'uz': 'Do\'kon yopiq',
      'ru': 'Магазин закрыт',
      'en': 'Shop is closed',
      'kk': 'Дүкен жабық',
    },
    'courier.active.cancel_reason_other': {
      'uz': 'Boshqa favqulodda holat',
      'ru': 'Другая экстренная ситуация',
      'en': 'Other emergency',
      'kk': 'Басқа төтенше жағдай',
    },
    'courier.active.map_placeholder': {
      'uz': '2GIS Navigator\n(production versiyada)',
      'ru': '2GIS Navigator\n(в production)',
      'en': '2GIS Navigator\n(production only)',
      'kk': '2GIS Navigator\n(өндіріс нұсқасында)',
    },
    'courier.active.eta_minutes': {
      'uz': '~{mins} daqiqa',
      'ru': '~{mins} мин',
      'en': '~{mins} min',
      'kk': '~{mins} мин',
    },
    'courier.active.items_list_title': {
      'uz': 'Mahsulotlar ro\'yxati',
      'ru': 'Список товаров',
      'en': 'Items list',
      'kk': 'Тауарлар тізімі',
    },
    'courier.active.ask_for_number_title': {
      'uz': 'Do\'kondan buyurtma raqamini so\'rang',
      'ru': 'Спросите в магазине номер заказа',
      'en': 'Ask the shop for the order number',
      'kk': 'Дүкеннен тапсырыс нөмірін сұраңыз',
    },
    'courier.active.ask_for_number_subtitle': {
      'uz': 'Sticker yoki chekdagi raqamni kiriting',
      'ru': 'Введите номер со стикера или чека',
      'en': 'Enter the number from the sticker or receipt',
      'kk': 'Стикерде немесе чекте көрсетілген нөмірді енгізіңіз',
    },
    'courier.active.number_invalid': {
      'uz': 'Noto\'g\'ri raqam. Qayta urinib ko\'ring',
      'ru': 'Неверный номер. Попробуйте ещё раз',
      'en': 'Wrong number. Try again',
      'kk': 'Қате нөмір. Қайта көріңіз',
    },
    'courier.active.number_hint_help': {
      'uz': 'Do\'kon panelida buyurtma raqami ko\'rsatilgan',
      'ru': 'Номер заказа отображается в панели магазина',
      'en': 'The order number is shown on the shop dashboard',
      'kk': 'Тапсырыс нөмірі дүкен панелінде көрсетіледі',
    },
    'courier.active.payment_method_prefix': {
      'uz': 'To\'lov:',
      'ru': 'Оплата:',
      'en': 'Payment:',
      'kk': 'Төлем:',
    },
    'courier.active.payment_paid': {
      'uz': 'To\'langan ✓',
      'ru': 'Оплачено ✓',
      'en': 'Paid ✓',
      'kk': 'Төленген ✓',
    },
    'courier.active.payment_take_cash': {
      'uz': 'Naqd pul oling',
      'ru': 'Возьмите наличные',
      'en': 'Take cash',
      'kk': 'Қолма-қол ақша алыңыз',
    },
    'courier.active.done_title': {
      'uz': 'Buyurtma yetkazildi!',
      'ru': 'Заказ доставлен!',
      'en': 'Order delivered!',
      'kk': 'Тапсырыс жеткізілді!',
    },
    'courier.active.done_earnings_label': {
      'uz': 'Daromadingiz',
      'ru': 'Ваш заработок',
      'en': 'Your earnings',
      'kk': 'Табысыңыз',
    },
    'courier.active.done_wait_rating': {
      'uz': '⭐ Xaridor sizni baholashini kuting',
      'ru': '⭐ Дождитесь оценки покупателя',
      'en': '⭐ Wait for the customer\'s rating',
      'kk': '⭐ Сатып алушының бағасын күтіңіз',
    },
    'courier.active.done_next_cta': {
      'uz': 'Yangi buyurtma qabul qilish',
      'ru': 'Принять новый заказ',
      'en': 'Accept a new order',
      'kk': 'Жаңа тапсырыс қабылдау',
    },
    'common.som_short': {
      'uz': 'so\'m',
      'ru': 'сум',
    ...
    // ── Role switcher (multi-role overlay) ──────────────────────────────────
    'role_switcher.title': {
      'uz': 'Rejimni tanlang',
      'ru': 'Выберите режим',
      'en': 'Choose mode',
    ...
    'role_switcher.subtitle': {
      'uz': 'Ilovani yopmasdan rol almashtiring',
      'ru': 'Переключайте роли без перезапуска',
      'en': 'Switch roles without closing the app',
      'kk': 'Қолданбаны жаппай рөл ауыстырыңыз',
    },
    'role_switcher.buyer_title': {
      'uz': 'Xaridor',
      'ru': 'Покупатель',
      'en': 'Buyer',
      'kk': 'Сатып алушы',
    },
    'role_switcher.buyer_sub': {
      'uz': 'Mahsulot buyurtma qilish',
      'ru': 'Заказывайте товары',
      'en': 'Order products',
      'kk': 'Тауар тапсырыс беру',
    },
    'role_switcher.courier_title': {
      'uz': 'Kuryer',
      'ru': 'Курьер',
      'en': 'Courier',
      'kk': 'Курьер',
    },
    'role_switcher.courier_sub_none': {
      'uz': 'Ro\'yxatdan o\'ting va daromad oling',
      'ru': 'Зарегистрируйтесь и зарабатывайте',
      'en': 'Sign up and start earning',
      'kk': 'Тіркеліп, табыс табыңыз',
    },
    'role_switcher.courier_sub_pending': {
      'uz': 'Ariza ko\'rib chiqilmoqda...',
      'ru': 'Заявка рассматривается...',
      'en': 'Application under review...',
      'kk': 'Өтінім қарастырылуда...',
    },
    'role_switcher.courier_sub_approved': {
      'uz': 'Buyurtma qabul qilib ishlang',
      'ru': 'Принимайте заказы и работайте',
      'en': 'Accept orders and start working',
      'kk': 'Тапсырыс қабылдап жұмыс істеңіз',
    },
    'role_switcher.courier_sub_rejected': {
      'uz': 'Rad etildi — qayta ariza bering',
      'ru': 'Отклонено — подайте заявку повторно',
      'en': 'Rejected — re-apply',
      'kk': 'Қабылданбады — қайта өтінім беріңіз',
    },
    'role_switcher.badge_pending': {
      'uz': 'Tekshirilmoqda',
      'ru': 'Проверяется',
      'en': 'Pending',
      'kk': 'Тексерілуде',
    },
    'role_switcher.badge_approved': {
      'uz': 'Faol',
      'ru': 'Активен',
      'en': 'Active',
      'kk': 'Белсенді',
    },
    'role_switcher.badge_rejected': {
      'uz': 'Rad etildi',
      'ru': 'Отклонено',
      'en': 'Rejected',
      'kk': 'Қабылданбады',
    },
    'role_switcher.shop_title': {
      'uz': 'Do\'kon',
      'ru': 'Магазин',
      'en': 'Shop',
      'kk': 'Дүкен',
    },
    'role_switcher.shop_sub_default': {
      'uz': 'Do\'kon boshqaruvi',
      'ru': 'Управление магазином',
      'en': 'Shop management',
      'kk': 'Дүкенді басқару',
    },
    'role_switcher.shop_sub_connect': {
      'uz': 'Do\'kon egasi? Ulaning',
      'ru': 'Владелец магазина? Подключайтесь',
      'en': 'Shop owner? Connect',
      'kk': 'Дүкен иесі? Қосылыңыз',
    },
    'role_switcher.shop_badge_connected': {
      'uz': 'Ulangan',
      'ru': 'Подключён',
      'en': 'Connected',
      'kk': 'Қосылған',
    },
    'role_switcher.buyer_emoji_label': {
      'uz': '🛒 Xaridor',
      'ru': '🛒 Покупатель',
      'en': '🛒 Buyer',
      'kk': '🛒 Сатып алушы',
    },
    'role_switcher.courier_emoji_label': {
      'uz': '🛵 Kuryer',
      'ru': '🛵 Курьер',
      'en': '🛵 Courier',
      'kk': '🛵 Курьер',
    },
    'role_switcher.shop_emoji_label': {
      'uz': '🏪 Do\'kon',
      'ru': '🏪 Магазин',
      'en': '🏪 Shop',
      'kk': '🏪 Дүкен',
    },
    'role_switcher.pending_dialog_title': {
      'uz': 'Ariza tekshirilmoqda',
      'ru': 'Заявка на проверке',
      'en': 'Application under review',
      'kk': 'Өтінім тексерілуде',
    },
    'role_switcher.pending_dialog_body': {
      'uz': 'Arizangiz 1-2 ish kuni ichida ko\'rib chiqiladi. Natija haqida SMS yuboramiz.',
      'ru': 'Заявка будет рассмотрена в течение 1-2 рабочих дней. Мы пришлём SMS с результатом.',
      'en': 'Your application will be reviewed within 1-2 business days. We will SMS you the result.',
      'kk': 'Өтінім 1-2 жұмыс күні ішінде қаралады. Нәтиже туралы SMS жібереміз.',
    },
    'role_switcher.pending_dialog_ok': {
      'uz': 'Tushunarli',
      'ru': 'Понятно',
      'en': 'Got it',
      'kk': 'Түсінікті',
    },
    'role_switcher.shop_connect_title': {
      'uz': 'Do\'konni ulash',
      'ru': 'Подключить магазин',
      'en': 'Connect a shop',
      'kk': 'Дүкенді қосу',
    },
    'role_switcher.shop_connect_body': {
      'uz': 'Do\'koningizni TezKetKaz ga ulang va buyurtma qabul qiling.',
      'ru': 'Подключите свой магазин к TezKetKaz и принимайте заказы.',
      'en': 'Connect your shop to TezKetKaz and start accepting orders.',
      'kk': 'Дүкеніңізді TezKetKaz-қа қосып, тапсырыс қабылдаңыз.',
    },
    'role_switcher.shop_demo_title': {
      'uz': 'Prototip: demo do\'kon',
      'ru': 'Прототип: демо-магазин',
      'en': 'Prototype: demo shop',
      'kk': 'Прототип: демо дүкен',
    },
    'role_switcher.shop_demo_body': {
      'uz': '«Korzinka — Yunusobod» do\'koni sifatida ulaning',
      'ru': 'Подключитесь как магазин «Korzinka — Yunusobod»',
      'en': 'Connect as the «Korzinka — Yunusobod» shop',
      'kk': '«Korzinka — Yunusobod» дүкені ретінде қосылыңыз',
    },
    'role_switcher.shop_connect_cta': {
      'uz': 'Do\'konni ulash',
      'ru': 'Подключить магазин',
      'en': 'Connect shop',
      'kk': 'Дүкенді қосу',
    ...
    'auth.name.subtitle': {
      'uz': 'Biz siz bilan bog\'lanishimiz uchun',
      'ru': 'Чтобы мы могли с вами связаться',
      'en': 'So we can reach out to you',
      'kk': 'Сізбен байланысу үшін',
    },
    'auth.name.hint': {
      'uz': 'Ism va familiya',
      'ru': 'Имя и фамилия',
